...
@Override
   public ObservableList<Categorie> sortCategorieAsc()
    ...
    public List<Categorie> tri() throws SQLException {
        List<Categorie> categories = new ArrayList<>();
        String req = "SELECT * FROM categorie ORDER BY nomCategorie";
        Statement st = conn.createStatement();
        ResultSet rs = st.executeQuery(req);


        while (rs.next()) {
            Categorie evenment = new Categorie();
              evenment.setNomCategorie(rs.getString("nomCategorie"));
