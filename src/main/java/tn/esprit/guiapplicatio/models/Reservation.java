...
public class Reservation {
    ...
    public int id_reservation, phone,id_seance;
    public String type_reservation, username, email;

    public Reservation(int id_reservation, String type_reservation, String username, String email, int phone,int id_seance) {
    ...
    public Reservation(String type_reservation, String username, String email, int phone,int id_seance) {
        this.phone = phone;
        this.type_reservation = type_reservation;
        this.username = username;
        this.email = email;
